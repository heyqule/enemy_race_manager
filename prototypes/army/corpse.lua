...
if data.raw['corpse']['common-erm-army-corpse'] == nil then
    local scale = 1
    data:extend({
        {
            type = "corpse",
            name = 'common-erm-army-corpse',
            ...
            subgroup = "corpses",
            order = "x-common-erm-army-corpse",
            hidden = true,
        ...
        },
        {
            ...
            final_render_layer = "lower-object-above-shadow",
            subgroup = "corpses",
            order = "x-common-erm-army-corpse-2",
            hidden = true,
            hidden_in_factoriopedia  = true,
            animation = {
                {
        ...
        },
        {
            ...
            final_render_layer = "lower-object-above-shadow",
            subgroup = "corpses",
            order = "x-common-erm-army-corpse-3",
            hidden = true,
            hidden_in_factoriopedia  = true,
            animation = {
                {
