...
function makeLevelSpawners(level, type)
    ...
    local result_units = (function()
        local res = {}
        res[1] = { ERM.MOD_NAME .. "--small-toxic-biter--" .. level, { { 0.0, 0.3 }, { 0.6, 0.0 } } }
        res[3] = { ERM.MOD_NAME .. "--small-toxic-spitter--" .. level, { { 0.25, 0.0 }, { 0.5, 0.3 }, { 0.7, 0.0 } } }
        res[2] = { ERM.MOD_NAME .. "--medium-toxic-biter--" .. level, { { 0.2, 0.0 }, { 0.6, 0.3 }, { 0.7, 0.0 } } }
        res[4] = { ERM.MOD_NAME .. "--medium-toxic-spitter--" .. level, { { 0.4, 0.0 }, { 0.7, 0.3 }, { 0.9, 0.0 } } }
        res[5] = { ERM.MOD_NAME .. "--big-toxic-biter--" .. level, { { 0.5, 0.0 }, { 1.0, 0.4 } } }
        res[6] = { ERM.MOD_NAME .. "--big-toxic-spitter--" .. level, { { 0.5, 0.0 }, { 1.0, 0.4 } } }
        res[7] = { ERM.MOD_NAME .. "--behemoth-toxic-biter--" .. level, { { 0.85, 0.0 }, { 1.0, 0.3 } } }
        res[8] = { ERM.MOD_NAME .. "--behemoth-toxic-spitter--" .. level, { { 0.85, 0.0 }, { 1.0, 0.3 } } }
    ...
    spawner["autoplace"] = enemy_autoplace.enemy_spawner_autoplace( {
        probability_expression = "enemy_autoplace_base(0, 90006)",
