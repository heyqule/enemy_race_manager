...
If you plan to modify a race or adding new feature to an enemy force.  It's recommend to copy the race as a new race mod and change it there.  It will have to publish under a new MOD_NAME and FORCE_NAME to avoid conflicts. 